...
<div class="row">
    ...
    <?php
         $element_text = ['All Posts','Active Post' ,'draft posts','Comment' ,'Pending Comments', 'Users', 'Subscriber', 'Categories'];
         $element_count = [$post_counts, $post_published_count, $post_draft_count, $comments_counts, $unapproved_comment_count , $users_counts,$subscriber_count,$categories_counts];
            for($i = 0;$i < 8; $i++){
